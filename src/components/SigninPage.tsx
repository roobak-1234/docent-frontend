...
const SigninPage: React.FC<SigninPageProps> = ({ onBack, onSuccess, onForgotPassword, onSignup }) => {
  ...
  return (
    <div className="min-h-screen bg-lifelink-bg flex items-center justify-center px-4 py-12 relative overflow-hidden">
      {/* Background Decor */}
      <div className="absolute top-[-10%] left-[-5%] w-[600px] h-[600px] bg-lifelink-secondary/5 rounded-full blur-3xl" />
      ...
      <div className="max-w-md w-full relative z-10">
        <div className="bg-white rounded-3xl shadow-xl shadow-slate-200/50 border border-slate-100 p-8 md:p-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              className="w-full py-4 bg-lifelink-primary text-white font-bold rounded-xl hover:bg-green-600 transition-colors shadow-lg shadow-green-500/20 disabled:opacity-70 flex items-center justify-center gap-2 mt-4"
              disabled={loading}
            >
            ...
            <p className="text-center text-sm text-slate-500 mt-6">
              Don't have an account? <span className="text-lifelink-primary font-bold cursor-pointer hover:underline" onClick={onSignup}>Sign Up</span>
            </p>
            ...
            <div className="text-center mt-4">
              <button
                ...
                className="text-sm text-lifelink-primary hover:underline font-medium"
              >
                Forgot Password?
              </button>
            </div>
