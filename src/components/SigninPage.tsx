      ...
      <div className="max-w-md w-full relative z-10">
        <div className="bg-white rounded-3xl shadow-xl shadow-slate-200/50 border border-slate-100 p-8 md:p-10">
          <div className="text-center mb-10">
            <div className="bg-transparent p-1 w-fit mx-auto mb-6 transition-transform duration-300 hover:scale-105">
              <img src="/docent_logo.png" alt="Docent Logo" className="h-20 w-20 object-contain" />
            </div>
